...
The main reason for that is that I get a CORS error since the API doesn't have Access-Control-Allow-Origin header. Tried fixing it, but decided to skip that error to work on the app to save time.
